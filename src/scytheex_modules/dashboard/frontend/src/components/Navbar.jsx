...
const Navbar = () => {
  return (
    <div className="fixed w-full flex items-center bg-gray-800 justify-between text-white z-10">
      <div className="flex items-center justify-start md:justify-center border-none">
        <img
          className="w-auto h-7 md:w-auto md:h-16 p-2 px-6 rounded-md overflow-hidden"
          src="./scth.png"
        />
      </div>
    </div>
